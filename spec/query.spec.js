...
describe("Test Query", function () {
    ...
    describe("Builder", function () {
        ...
        it("should create text condition", function () {
            var q = db.QueryPerson.find()
                .text("text-search");
        ...
        it("should create text condition with options", function () {
            var q = db.QueryPerson.find()
                .text("text-search", "german", true, false);
    ...
    describe('execution', function () {
        ...
        before(function () {
            ...
            p1 = new db.QueryPerson({
                ...
                colors: ['red', 'green'],
                summary: 'Hello my Name is Person 1',
            ...
            p3 = new db.QueryPerson({
                ...
                summary: 'Hello my Name is Person 3. NAME Name Name',
            ...
            let personType = new DB.metamodel.EntityType("QueryPerson", metamodel.entity(Object));
        ...
        it('should return text search for summary orderd by text score', function () {
            return db.QueryPerson.find().text("Name").resultList().then(function (list) {
                expectSortedResult([p3, p1], list)
            })
        });

        it('should return text search wiht case sensitivity for summary orderd by text score', function () {
            return db.QueryPerson.find().text("NAME", null, true).resultList().then(function (list) {
                expectSortedResult([p3], list)
            })
        });

        it('should return text search wiht diacritic sensitivity for summary orderd by text score', function () {
            return db.QueryPerson.find().text("Persón", null, false, true).resultList().then(function (list) {
                expectSortedResult([p2], list)
            })
        });
