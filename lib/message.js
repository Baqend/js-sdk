 ...
 * @param {string} start The offset to skip
 ...
 *
 * @param {string} bucket The bucket name
 * @param {string} start The offset to start from
 * @param {number} count The number of objects to list
 * @param {Object} sort The sort object
 * @param {json} body The massage Content
 */
 ...
 * @extends connector.Message
 *
 * @param {object} body The device register message body
 * @param {string} body.devicetype The OS of the device (IOS/Android)
 * @param {Subscription} body.subscription WebPush subscription
 * @param {model.Device} body.device A device entity to set custom field values
 */
