 ...
 *
 * @class message.GenerateVAPIDKeys
 * @extends connector.Message
 *
 */
exports.GenerateVAPIDKeys = Message.create({
  method: 'POST',
  path: '/config/GenerateVAPIDKeys',
  status: [200],
});
 ...
 *
 * @class message.GetVAPIDPublicKey
 * @extends connector.Message
 *
 */
exports.GetVAPIDPublicKey = Message.create({
  method: 'GET',
  path: '/config/GetVAPIDPublicKey',
  status: [200],
});
