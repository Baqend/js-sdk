 ...
 */
exports.MapAttribute = MapAttribute = PluralAttribute.inherit(/** @lends baqend.metamodel.MapAttribute.prototype */ {
    ...
    if (value) {
      ...
      for (var iter = value.items(), item = iter.next(); !item.done; item = iter.next()) {
        if (item.index === null || item.index === undefined)
          throw new baqend.error.PersistentError('Map keys can\'t be null nor undefined.');
