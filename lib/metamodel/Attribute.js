 ...
 */
exports.Attribute = Attribute = Object.inherit(/** @lends baqend.metamodel.Attribute.prototype */ {
  /**
  ...
  getValue: function (entity) {
    if (this.isId || this.isVersion)
      return entity._metadata[this.name];
  ...
  setValue: function (entity, value) {
    if (this.isId || this.isVersion) {
      entity._metadata[this.name] = value;
    } else {
