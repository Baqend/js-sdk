...
class ManagedType extends Type {
  ...
  set typeConstructor(typeConstructor) {
    ...
    let isEntity = typeConstructor.prototype instanceof binding.Entity;
    if (this.isEntity) {
      if (!isEntity)
   ...
   * @param {binding.Enhancer} enhancer The class enhancer used to enhance and instantiate instance of this managed class
   * @return {void}
   */
  init(enhancer) {
