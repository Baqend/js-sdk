...
exports.Metamodel = Metamodel = Object.inherit(/** @lends jspa.metamodel.Metamodel.prototype */ {
  initialize: function () {
    ...
    this.addType(new BasicType('Boolean', Boolean));

    this.addType(new BasicType('Float', Number));
    this.addType(new BasicType('Integer', Number));
    this.addType(new BasicType('String', String));

    this.addType(new (BasicType.inherit({
    ...
    this.addType(new BasicType('DateTime', Date));

    var objectModel = new EntityType('/db/_native.Object', null, Object);
    objectModel.declaredAttributes = [];
    objectModel.declaredId = new SingularAttribute(objectModel, 'oid', this.baseType(String));
    objectModel.declaredId.isId = true;

    objectModel.declaredVersion = new SingularAttribute(objectModel, 'version', this.baseType(String));
