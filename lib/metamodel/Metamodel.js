...
exports.Metamodel = Metamodel = Object.inherit(/** @lends jspa.metamodel.Metamodel.prototype */ {
  ...
  toJSON: function() {
    ...
    for (var ref in this._entities) {
      json.push(this._entities[ref].toJSON());
    }

    for (ref in this._embeddables) {
      json.push(this._embeddables[ref].toJSON());
    }
