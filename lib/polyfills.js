...
},{"./handlers":3,"immediate":15}],15:[function(_dereq_,module,exports){
  'use strict';
  var types = [
    _dereq_('./nextTick'),
    _dereq_('./mutation.js'),
...
},{"./messageChannel":16,"./mutation.js":17,"./nextTick":20,"./stateChange":18,"./timeout":19}],16:[function(_dereq_,module,exports){
  (function (global){
    'use strict';
