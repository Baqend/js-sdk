...
class EntityManagerFactory extends util.Lockable {
  ...
  constructor(options) {
    ...
    /** @type number */
    this.bloomFilterRefresh = options.bloomFilterRefresh == undefined? 60: options.bloomFilterRefresh;
   ...
   *
   * @param {boolean|util.TokenStorage=} tokenStorage The token storage to persist the authorization token, or
