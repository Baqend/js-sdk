...
exports.Collection = collection.Collection.inherit(tracked.Collection, {});
exports.List = collection.List.inherit(tracked.List, {});
exports.Set = collection.Set.inherit(tracked.Set, {});
exports.Map = collection.Map.inherit(tracked.Map, {});
...
exports.GeoPoint = GeoPoint = Object.inherit(/** @lends jspa.GeoPoint.prototype */ {
  ...
  extend: {
     ...
     * @return {jspa.Promise} A promise that will be resolved with a GeoPoint
     */
    current: function() {
   ...
   *
   * @param {Number|Object|Array=} latitude The
   * @param {Number=} longitude
   */
  initialize: function(latitude, longitude) {
    if (Number.isInstance(latitude)) {
   ...
   */
  toString: function() {
    return Math.abs(this.latitude) + '°' + (this.latitude >= 0? 'N': 'S') + ', '
