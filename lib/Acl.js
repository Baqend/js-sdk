...
class Acl {
  ...
  /**
   * Allows the given user or rule to read and write the object
   * @param {model.User|model.Role|string} userOrRole The user or role to allow
   * @return {Acl} this acl object
   */
  allowAccess(userOrRole) {
    this.allowReadAccess(userOrRole);
    this.allowWriteAccess(userOrRole);
    return this;
  }

  /**
   * Denies the given user or rule to read and write the object
   * @param {model.User|model.Role|string} userOrRole The user or role to deny
   * @return {Acl} this acl object
   */
  denyAccess(userOrRole) {
    this.denyReadAccess(userOrRole);
    this.denyWriteAccess(userOrRole);
    return this;
  }
