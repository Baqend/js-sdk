...
exports.Iterator = Iterator = Trait.inherit( /** @lends baqend.collection.Iterator.prototype */ {
   ...
   * @return {T} item.value The current iterating value
   */
  next: function() {
...
exports.Iterable = Iterable = Trait.inherit( /** @lends baqend.collection.Iterable.prototype */ {
   ...
   * @return {Iterator<[*,*]>} An iterator where each entry is a key - value pair
   */
  entries: function() {
    return null;
  },
...
exports.Collection = Collection = Object.inherit(Iterable, /** @lends baqend.collection.Collection.prototype */ {
   ...
   * @returns {baqend.collection.Iterator.<[Number, *]>} An iterator over the entries of the collection
   */
  entries: function() {
...
exports.Map = Map = Collection.inherit(/** @lends baqend.collection.Map.prototype */ {
   ...
   * @returns {baqend.collection.Iterator.<[*, *]>} An iterator over the key value pairs of the map
   */
  entries: function() {
    var keys = this.array;
    var vals = this.vals;
