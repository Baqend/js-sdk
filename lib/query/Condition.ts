...
export interface Condition<T extends Entity> {
   ...
   * @return {Filter<T>} The resulting Query
   */
  where(conditions): Filter<T>;
   ...
   */
  notEqual(field, value): Filter<T>;

  /**
   * Adds a greater than filter to the field
   *
   * @param {string} field The field to filter
   * @param {number|string|Date|Entity} value The value used to filter
   * @return {Filter<T>} The resulting Query
   *
   * @see http://docs.mongodb.org/manual/reference/operator/query/gt/
   */
  greaterThan(field, value): Filter<T>;
   ...
   */
  greaterThanOrEqualTo(field, value): Filter<T>;
   ...
   */
  lessThanOrEqualTo(field, value): Filter<T>;

  /**
   * Adds a between filter to the field. This is a shorthand for an less than and greater than filter.
   * @param {string} field The field to filter
   * @param {number|string|Date|Entity} greaterValue The field value must be greater than this value
   * @param {number|string|Date|Entity} lessValue The field value must be less than this value
   * @return {Filter<T>} The resulting Query
   */
  between(field, greaterValue, lessValue): Filter<T>;
   ...
   */
  containsAll(field, ...args): Filter<T>;
   ...
   */
  mod(field, divisor, remainder): Filter<T>;
   ...
   */
  near(field, geoPoint, maxDistance): Filter<T>;
   ...
   */
  withinPolygon(field, ...geoPoints): Filter<T>;
   ...
   * @see http://docs.mongodb.org/manual/reference/operator/query/in/
   */
  containsAny(field, ...args): Filter<T>;
   ...
   * @return {Filter<T>} The resulting Query
   */
  addFilter(field, filter, value): Filter<T>;
}
