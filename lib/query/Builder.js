...
class Builder extends Query {
   ...
   * @param {...(Query<T>|Array<Query<T>>)} args The query nodes to join
   * @return {Query<T>} Returns a new query which joins the given queries by a logical AND
   */
  and(args) {
   ...
   * @param {...(Query<T>|Array<Query<T>>)} args The query nodes to join
   * @return {Query<T>} Returns a new query which joins the given queries by a logical OR
   */
  or(args) {
   ...
   * @param {...(Query<T>|Array<Query<T>>)} args The query nodes to join
   * @return {Query<T>} Returns a new query which joins the given queries by a logical NOR
   */
  nor(args) {
