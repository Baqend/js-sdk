...
var OfflineService = require('../../offline/offlineService');
...
class Node extends Query {
  ...
  resultList(options, doneCallback, failCallback) {
    ...
    if(offlineService.isOnline()) {
        ...
        return offlineService.queryLocalData(query, sort, this.maxResults, type.name).then((result) => {
  ...
  singleResult(options, doneCallback, failCallback) {
    ...
    if(offlineService.isOnline()) {
        ...
        return offlineService.queryLocalData(query, sort, 1, type.name).then((result) => {
