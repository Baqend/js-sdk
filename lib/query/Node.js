...
class Node extends Query {
  ...
  stream(fetchQuery, matchType) {
    ...
    return new Stream(this.entityManager, type.name, this._serializeQuery(), fetchQuery, sort, this.maxResults, this).observable(matchType);
  }
