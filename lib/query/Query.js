...
class Query {
  ...
  /**
   * Returns an observable that receives events for streaming query.
  ...
  /**
   * Returns an observable that receives events for streaming query results.
   * @param {Object} [options] additional options
   * @return {Observable<Array<T>>} an observable with the current complete result
   */
