...
class Query {
   ...
   * @return {Query<T>} The resulting Query
   */
  ascending(field) {
   ...
   * @param {Query~resultListCallback=} doneCallback Called when the operation succeed.
   * @param {Query~failCallback=} failCallback Called when the operation failed.
   ...
   * @param {Query~singleResultCallback=} doneCallback Called when the operation succeed.
   * @param {Query~failCallback=} failCallback Called when the operation failed.
   ...
   * @param {Query~countCallback=} doneCallback Called when the operation succeed.
   * @param {Query~failCallback=} failCallback Called when the operation failed.
 ...
 * @callback Query~resultListCallback
 ...
 * @callback Query~singleResultCallback
