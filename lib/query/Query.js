...
class Query {
  ...
  /**
   * Returns an observable that receives change events for a real-time query. Multiple subscriptions can be created on
   * top of this observable:
   *
   <pre><code>
  ...
  /**
   * Returns an observable that receives the complete real-time query result. The full result is received initially
   * (i.e. on subscription) and on every change.
   *Will
   var query = DB.Todo.find();
  ...
  /**
   * Returns a subscription that handles the complete real-time query result. The full result is received initially
   * (i.e. on subscription) and on every change.
   *
   * The underlying stream object is hidden. To create multiple subscriptions on the same stream, create the stream
