...
class Stream {
  ...
  _wrapQueryCallback(cb) {
    return function(msg) {
      ...
      if (msg.result !== undefined) { //Initial result received
  ...
  _createObject(object, objectWasDeleted) {
    var entity = this.entityManager.getReference(object.id);
    if ((object !== undefined && object !== null) && entity.id === object.id && (entity.version < object.version || objectWasDeleted)) {
      if (objectWasDeleted) {
        object.version = -1;
      }
