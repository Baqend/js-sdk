...
/**
 * @class jspa.util.Permission
 */
exports.Permission = Permission = Object.inherit(/** @lends jspa.util.Permission.prototype */ {
   ...
   * @return {jspa.util.Permission} this permission object
   */
  ...
  _getRef: function(userOrRole) {
    ...
    if (userOrRole.indexOf('/db/_native.User/') || userOrRole.indexOf('/db/_native.Role/')) {
      return userOrRole;
    }
