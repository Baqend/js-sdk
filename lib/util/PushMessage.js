...
class PushMessage {
   ...
   * @param {string=} options.badge The number for iOS and Android devices which will occur on the top right of the icon
   ...
   * @param {Array=} options.actions Actions that the user can invoke and interact with (web push only)
   ...
   */
  constructor(devices, message, subject, options) {
    /**
     * Set of devices
