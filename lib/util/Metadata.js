...
var Metadata = Object.inherit(Lockable, /** @lends baqend.util.Metadata.prototype */ {
   ...
   * @param {Boolean=false} excludeVersion
   * @param {Boolean=false} excludeMetadata
   * @returns {Object} JSON-Object
   */
  getJson: function(excludeVersion, excludeMetadata) {
    this._enabled = false;
    var json = this.type.toJsonValue(this, this._root);
    this._enabled = true;
  ...
  setJson: function(json) {
    ...
    this._enabled = false;
    this.type.fromJsonValue(this, json, this._root);
    this._enabled = true;
  }
});
