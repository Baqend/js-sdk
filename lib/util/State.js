...
exports.State = State = Object.inherit(/** @lends jspa.util.State.prototype */ {
  ...
  extend: {
     ...
     */
    get: function (entity) {
      if (entity.__jspaEntity__)
        entity = entity.__jspaEntity__;

      return entity._objectInfo && entity._objectInfo.state;
    },

    readAccess: function(obj) {
      var state = State.get(obj);
  ...
  isTemporary: {
    get: function () {
      return this.state == State.Type.NEW;
    }
  },
  ...
  initialize: function (entityManager, type, entity) {
    ...
    Object.defineProperty(this.entity, 'db', {
  ...
  setDatabaseObject: function (json) {
    ...
    if (!this.isDirty) {
      ...
      this.type.fromDatabaseValue(this, json, this.entity);
