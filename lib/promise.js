 ...
 * @class jspa.Promise
 */
exports.Promise = Promise = Object.inherit(Bind, /** @lends jspa.Promise.prototype */ {
  /**
   * @lends jspa.Promise
   */
  extend: {
 ...
 * @class Deferred
 */
exports.Deferred = Deferred = Promise.inherit(/** @lends jspa.Deferred.prototype */ {
  /**
   * @lends jspa.Deferred
   */
  extend: {
  ...
  rejectWith: function (context, args) {
    ...
    if (this.state == 'pending') {
      ...
      if (!this.call(this.failCallbacks))
        Deferred.onError.apply(this, args);
