...
var ObjectFactory = require('./binding/ObjectFactory').ObjectFactory;
...
exports.EntityManager = EntityManager = Object.inherit(/** @lends jspa.EntityManager.prototype */ {
  ...
  save: function(entity) {
    ...
    return entity.ready(function() {
      ...
      if (state.isDirty) {
        return this._connector.send(new message.ReplaceObject(state.bucket, state.id, state.getDatabaseObject())).done(function(msg) {
