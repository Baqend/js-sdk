  ...
  loginWithOAuth: function(provider) {
    if( provider == "google") {
      var src = 'https://accounts.google.com/o/oauth2/auth' +
          ...
          '&redirect_uri=' + encodeURIComponent('https://internal.baqend.com:8443/db/User/OAuth/google/?isGlobal=true') +
          '&scope=' + 'email' +
      ...
      var src = 'https://www.facebook.com/dialog/oauth' +
          '?response_type=code' +
          '&client_id=' + '1632701890347759' +
          '&scope=' + 'email' +
          '&state=' + Math.floor(Math.random() * 1000000) +
          '&redirect_uri=' + encodeURIComponent('https://internal.baqend.com:8443/db/User/OAuth/facebook/?isGlobal=true');
      ...
      var src = 'https://github.com/login/oauth/authorize' +
          '?response_type=code' +
          '&client_id=' + 'b715d31b104ecfe6e7aa' +
          '&redirect_uri=' + encodeURIComponent('https://internal.baqend.com:8443/db/User/OAuth/github/?isGlobal=true') +
          '&scope=' + 'user:email' +
          '&state=' + Math.floor(Math.random() * 1000000) +
          '&access_type=' + 'online';
    }
