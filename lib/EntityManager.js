...
exports.EntityManager = EntityManager = Object.inherit(/** @lends jspa.EntityManager.prototype */ {
  ...
  register: function(username, password) {
    var emf = this.entityManagerFactory;
    return this._userRequest(emf.register.bind(emf, username, password, DB != this));
  },

  login: function(username, password) {
    var emf = this.entityManagerFactory;
    return this._userRequest(emf.login.bind(emf, username, password, DB != this));
  },

  logout: function() {
    var emf = this.entityManagerFactory;
    return this.withLock(function() {
      return emf.logout(DB != this).then(function() {
        this._me = null;
        this._token = null;
      }.bind(this));
    }.bind(this));
  ...
  _userRequest: function(request) {
    return this.withLock(function() {
      if (this._me)
        throw new Error('User is already logged in.');

      return request().then(function(msg) {
