...
var StatusCode = require('./connector/Message').Message.StatusCode;

/**
 * @class baqend.EntityManager
 *
 * @param {jspa.EntityManagerFactory} entityManagerFactory The factory which of this entityManager instance
 */
exports.EntityManager = EntityManager = Object.inherit(/** @lends baqend.EntityManager.prototype */ {
  ...
  run: function(bucket, obj, doneCallback, failCallback) {
      ...
      return this.code.callCode(bucket, obj, this.token).then(doneCallback, failCallback);
  },
  ...
  validate: function(entity) {
    var type = util.Metadata.get(entity).type;
