...
exports.EntityManager = EntityManager = Object.inherit(/** @lends jspa.EntityManager.prototype */ {
  ...
  initialize: function(entityManagerFactory) {
    ...
    this.enhanceFactory(this.metamodel._embeddables);
    this.enhanceFactory(this.metamodel._entities);

    this.transaction = new EntityTransaction(this);
  },

  enhanceFactory: function(entities) {
    Object.keys(entities).forEach(function(identifier) {
      var entityType = this.metamodel.managedType(identifier);
      Object.defineProperty(this, entityType.name, {
        get: function() {
          Object.defineProperty(this, entityType.name, {
            value: Enhanced.createFactory(entityType.typeConstructor, this, entityType.isEntity)
          });
