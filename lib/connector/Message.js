...
class Message {
  ...
  /**
   * Overwrites the default mimeType
  ...
  /**
   * Makes the request conditional by setting the If-Match header
  ...
  /**
   * Make the request a ETag based conditional request
  ...
  /**
   * Make the request a date based conditional request
   * @param {Date} date The date value
   * @return {baqend.connector.Message} This message object
   */
  ifUnmodifiedSince(date) {
    return this.header('if-unmodified-since', date.toUTCString());
  }
  ...
  /**
   * Encodes the acl of a file into the Baqend-Acl header
   * @param {baqend.Acl} acl the file acls
   * @return {baqend.connector.Message} This message object
   */
  acl(acl) {
    return this.header('baqend-acl', JSON.stringify(acl));
  }
