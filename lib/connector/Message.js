...
class Message {
  ...
  constructor() {
    ...
    /** @type connection.Message~progressCallback */
   ...
   * @return {connection.Message|string} This message object
   */
  header(name, value) {
    if (value !== undefined) {
   ...
   * @return {connection.Message} This message object
   */
  entity(data, type) {
   ...
   * @param {string|null=} mimeType the mimeType of the data
   * @return {connection.Message} This message object
   */
  mimeType(mimeType) {
   ...
   * @param {number|null=} contentLength the content length of the data
   * @return {connection.Message} This message object
   */
   ...
   * @param {string|null=} eTag the If-Match ETag value
   * @return {connection.Message} This message object
   */
  ifMatch(eTag) {
   ...
   * @param {string|null=} type The response type one of 'json'|'text'|'blob'|'arraybuffer' defaults to 'json'
   * @return {connection.Message} This message object
   */
  responseType(type) {
    if (type !== undefined) {
   ...
   * @param {connection.Message~progressCallback} callback
   * @return {connection.Message} This message object
   */
  progress(callback) {
  ...
  addQueryString(query) {
    if (Object(query) instanceof String) {
      ...
      let sep = this.request.path.indexOf('?') === -1 ? '?' : '&';
 ...
 * @name spec
 * @memberOf connection.Message.prototype
 * @type {Object}
 */
