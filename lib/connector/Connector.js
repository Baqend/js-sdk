...
class Connector {
   ...
   * @returns {Promise<connection.Message>}
   */
  send(message) {
   ...
   * @abstract
   * @name doSend
   * @memberOf connection.Connector.prototype
   */
   ...
   * @param {connection.Message} message The message to send
   * @protected
   * @abstract
   */
...
Object.assign(Connector, /** @lends connection.Connector */ {
   ...
   * @type Object<string,connection.Connector>
   */
  connections: {},
