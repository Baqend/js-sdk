...
var QueueConnector = require('./util').QueueConnector;

/**
 * @class jspa.EntityTransaction
 * @extends jspa.util.QueueConnector
 */
exports.EntityTransaction = EntityTransaction = QueueConnector.inherit(/** @lends jspa.EntityTransaction.prototype */ {
