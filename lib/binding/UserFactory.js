...
const UserFactory = EntityFactory.extend(/** @lends binding.UserFactory.prototype */ {
  ...
  requestAPIToken(user, doneCallback, failCallback) {
    return this.db.requestAPIToken(this._managedType.typeConstructor, user).then(doneCallback, failCallback);
  },
  ...
  revokeAllTokens(user, doneCallback, failCallback) {
    return this.db.revokeAllTokens(this._managedType.typeConstructor, user).then(doneCallback, failCallback);
  }
