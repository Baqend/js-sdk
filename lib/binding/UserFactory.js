 ...
 */
exports.UserFactory = UserFactory = EntityFactory.inherit(/** @lends baqend.binding.UserFactory.prototype */ {
   ...
   * @return {Q.Promise<baqend.binding.User>} The created user object, for the new registered user.
   */
   ...
   * @param {baqend.binding.Entity~doneCallback=} doneCallback Called when the operation succeed.
   * @param {baqend.binding.Entity~failCallback=} failCallback Called when the operation failed.
   * @return {Q.Promise<baqend.binding.User>}
   */
