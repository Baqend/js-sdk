...
exports.EntityFactory = EntityFactory = ManagedFactory.inherit(/** @lends baqend.binding.EntityFactory.prototype */ {
  ...
  _getCode: function(codeType) {
    var fn = this._db.code.getCode(this._managedType.name, codeType);
    if(fn) {
      return function(obj) {
