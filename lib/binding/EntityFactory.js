...
var EntityFactory = ManagedFactory.extend(/** @lends baqend.binding.EntityFactory.prototype */ {
   ...
   * @param {Boolena} [options.refresh=false] Indicates whether the object should be revalidated (cache bypass).
   * @param {Boolena} [options.local=false] Indicates whether the local copy (from the entity manager)
