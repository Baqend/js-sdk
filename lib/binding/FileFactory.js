...
var FileFactory = Factory.extend(/** @lends baqend.binding.FileFactory.prototype */ {
   ...
   * @return {Array<baqend.binding.File>} The listed buckets.
   */
   ...
   *
   * @param {baqend.binding.File|string} folder The folder/path to list.
   * @param {baqend.binding.File} start The file/folder from where to start listing (not included)
   * @param {number} count The maximum number of files to return.
   * @return {Array<baqend.binding.File>} The listed files/folders.
   */
