...
/**
 * Content encoding indicates which encodings were applied to the file's body
 * @alias binding.FileFactory.Encoding
 * @enum {string}
 */
FileFactory.Encoding = {
  /**
  ...
  DEFLATE: 'deflate',
  /**
   * The encoding format uses the Brotli algorithm
   */
  BROTLI: 'br',
};
