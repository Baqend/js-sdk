 ...
 *     <td>'data-url'</td>
 *     <td>string</td>
 *     <td>A data url which represents tde file content</td>
 *   </tr>
 * </table>
 * 
 *
...
class File {
   ...
   * @param {baqend.binding.File~downloadCallback=} doneCallback The callback is invoked after the upload succeed successfully
   * @param {baqend.binding.File~failCallback=} failCallback The callback is invoked if any error is occurred
