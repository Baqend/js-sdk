...
class File {
  ...
  constructor(fileOptions) {
    ...
    if (Object(fileOptions) instanceof String) {
      ...
      this[id] = fileOptions.id;
      this.setDataOptions(fileOptions);
    } else {
      let path;
      if (fileOptions.path) {
  ...
  upload(uploadOptions, doneCallback, failCallback) {
    ...
    this.setDataOptions(uploadOptions);
    ...
    this.conditional(uploadMessage, uploadOptions);
  ...
  download(downloadOptions, doneCallback, failCallback) {
    ...
    this.db.ensureCacheHeader(this.id, downloadMessage, downloadOptions.refresh);
  ...
  delete(deleteOptions, doneCallback, failCallback) {
    ...
    this.conditional(deleteMessage, deleteOptions);
  ...
  loadMetadata(options, doneCallback, failCallback) {
    ...
    this.db.ensureCacheHeader(this.id, msg, options.refresh);
  ...
  setDataOptions(options) {
    ...
    this.fromJSON(Object.assign({}, options, {
      mimeType,
    }));
  }
