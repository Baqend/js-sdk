...
class File {
   ...
   * @param {Map=} fileOptions.customHeaders The custom headers which will be send with the file after uploading it
   */
   ...
   * @param {Map=} uploadOptions.customHeaders The custom headers which will be send with the file after uploading it
