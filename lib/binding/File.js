...
class File {
   ...
   * @param {object=} fileOptions.headers The custom headers which will be send with the file after uploading it
   */
   ...
   * @param {object=} uploadOptions.headers The custom headers which will be send with the file after uploading it
