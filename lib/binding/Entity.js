...
Object.defineProperties(Entity.prototype, /** @lends binding.Entity.prototype */ {
  ...
  id: {
    ...
    set(value) {
      ...
      const val = value + '';
      if (val.indexOf('/db/' + this.metadata.bucket + '/') === 0) {
  ...
  ready: {
    value: function ready(doneCallback) {
      return this.metadata.ready(doneCallback);
    },
  },
  ...
  save: {
    value: function save(options, doneCallback, failCallback) {
      ...
      return this.metadata.db.save(this, options).then(doneCallback, failCallback);
    },
  },
  ...
  insert: {
    value: function insert(options, doneCallback, failCallback) {
      ...
      return this.metadata.db.insert(this, options).then(doneCallback, failCallback);
    },
  },
  ...
  update: {
    value: function update(options, doneCallback, failCallback) {
      ...
      return this.metadata.db.update(this, options).then(doneCallback, failCallback);
    },
  },
  ...
  load: {
    value: function load(options, doneCallback, failCallback) {
      ...
      return this.metadata.db.load(this.id, null, options).then(doneCallback, failCallback);
    },
  },
  ...
  delete: {
    value: function deletee(options, doneCallback, failCallback) {
      ...
      return this.metadata.db.delete(this, options).then(doneCallback, failCallback);
    },
  },
  ...
  optimisticSave: {
    value: function optimisticSave(cb, doneCallback, failCallback) {
      return this.metadata.db.optimisticSave(this, cb).then(doneCallback, failCallback);
    },
  },
  ...
  validate: {
    value: function validate() {
      return this.metadata.db.validate(this);
    },
  },
  ...
  getReferencing: {
    value: function getReferencing(options) {
      ...
      const references = this.metadata.type.getReferencing(db, options);
  ...
  toJSON: {
    value: function toJSON(options) {
      ...
      return this.metadata.getJson(options);
    },
  },
});
