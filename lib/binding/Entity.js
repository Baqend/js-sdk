...
Object.defineProperties(Entity.prototype, /** @lends binding.Entity.prototype */ {
   ...
   *
   * @returns {Promise.<binding.Entity>} A promise resolving with an array of all referencing objects
   * @method
   */
  getReferencing: {
    value: function getReferencing(operations) {
      const db = this._metadata.db;
      const references = this._metadata.type.getReferencing(db);
