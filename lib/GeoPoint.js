 ...
 */
exports.GeoPoint = GeoPoint = Object.inherit(/** @lends baqend.GeoPoint.prototype */ {
  ...
  extend: {
     ...
     * @return {Q.Promise<baqend.GeoPoint>} A promise that will be resolved with a GeoPoint
     */
    current: function() {
